...
object BridgeManager {
    ...
    fun startOrGetBrowserUrl(
        ...
        val bridgeBinary = File(context.applicationInfo.nativeLibraryDir, "libMbfBridge.so").absolutePath
        ...
        return startupUrl.get() ?: throw IllegalStateException("MBF bridge did not return a browser URL.")
    }
}
