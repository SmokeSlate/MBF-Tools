...
object AppPrefs {
    ...
    fun getPairingPort(context: Context): String = prefs(context).getString(KEY_PAIRING_PORT, "") ?: ""
    ...
    fun getGameId(context: Context): String {
        return prefs(context).getString(KEY_GAME_ID, "com.beatgames.beatsaber") ?: "com.beatgames.beatsaber"
    }

    fun setGameId(context: Context, value: String) {
        prefs(context).edit().putString(KEY_GAME_ID, value.ifBlank { "com.beatgames.beatsaber" }).apply()
    }
